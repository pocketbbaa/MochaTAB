            ...
            <table id="myTable" border="0" width="90">
                ...
                <c:forEach items="${productList}" var="product">
                    <tr>
                        ...
                        <td><a href="${ctx}/case/add/stepOne/${product.id}" class="btn btn-primary" role="button">选择该商品</a></td>
                        <%--<td><a href="${ctx}/views/evaluation/case_add.jsp" class="btn btn-primary" role="button">选择该商品</a></td>--%>
                    </tr>
                </c:forEach>
