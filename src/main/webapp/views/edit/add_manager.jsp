    ...
    <section class="widget">
        <div class="content">
            <div style="margin-left: 20%">
                <form class="form-horizontal" action="${ctx}/edit/add" method="post">

                    <div class="form-group" style="height: 45px; margin-top: 10px;">
                        <label for="username" class="col-sm-2 control-label">账号</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="username" placeholder="登陆账号，纯字母组成"
                    ...
                    <div class="form-group" style="height: 45px; margin-top: 10px;">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="password" placeholder="4-6位数字或字母"
